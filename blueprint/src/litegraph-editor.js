...
/*    this.addLoadCounter();
  ...
  var nodeModel = LiteGraph.createNode("graph/model");//!!
  nodeModel.pos = [50,200];
 // nodeConstA.setValue(4.5);
  graph.add(nodeModel);

  var nodeMaterial1 = LiteGraph.createNode("graph/material");//!!
  nodeMaterial1.pos = [300,150];
 // nodeConstA.setValue(4.5);
  graph.add(nodeMaterial1);
  nodeModel.connect( 0, nodeMaterial1, 0 );


  var nodeMaterial2 = LiteGraph.createNode("graph/material");//!!
  nodeMaterial2.pos = [300,250];
 // nodeConstA.setValue(4.5);
  graph.add(nodeMaterial2);
  nodeModel.connect( 0, nodeMaterial2, 0 );


  var nodeTexture1 = LiteGraph.createNode("graph/texture");//!!
  nodeTexture1.pos = [550,100];
  graph.add(nodeTexture1);

  var nodeTexture2 = LiteGraph.createNode("graph/texture");//!!
  nodeTexture2.pos = [550,200];
  graph.add(nodeTexture2);

  var nodeTexture3 = LiteGraph.createNode("graph/texture");//!!
  nodeTexture3.pos = [550,300];
  graph.add(nodeTexture3);


  nodeMaterial1.connect( 0, nodeTexture1, 0 );
