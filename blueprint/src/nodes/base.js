...
//    LiteGraph.registerNodeType("basic/time", Time);
	...
	*/
    ...
    LiteGraph.registerNodeType("graph/model", GraphInput);

    //Bypass
    function Bypass() {
        this.addInput("model");
        this.addOutput("material object");
        this.size = [180, 30];
    }

    Bypass.title = "Material";
    ...
    LiteGraph.registerNodeType("graph/material", Bypass);
    ...
    LiteGraph.registerNodeType("graph/texture", GraphOutput);
